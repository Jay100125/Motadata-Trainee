...
public class TextDataPersistenceManager {
  private static final String TRAINS_FILE = "./src/TrainManagmentSystem/data/trains.csv";
  private static final String COACHES_FILE = "./src/TrainManagmentSystem/data/coaches.csv";
  private static final String BOOKINGS_FILE = "./src/TrainManagmentSystem/data/bookings.csv";
  private static final String SEATS_FILE = "./src/TrainManagmentSystem/data/seats.csv";
